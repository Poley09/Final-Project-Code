...
#define RF_DATA_ARRAY_SIZE 2 //The number of elements to be held in the array

#define RF_DATA_DECIMAL_PLACES 4//The number of decimal places that will be encoded
